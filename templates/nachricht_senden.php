...
<br><br><br>
  <body>
    ...
    <br>
    <h1 style="font-weight: 700; letter-spacing: 0.5px; font-size: 45px;">Danke für dein Feedback!</h1>
    <br>

	<div class="alert alert-info" role="alert">
	  Ihre Nachricht ist erfolgreich bei uns eingegangen. Vielen Dank!
	</div>

		<br>
<a href="templates/kontakt.php" class="btn umfrage_btn" tabindex="-1" role="button" aria-disabled="true">zurück zur Website</a>
